...
plt.xlabel('log(Energy)',fontsize=20)
# naming the y axis
plt.ylabel(r'E$\phi_{\nu_{\mu}}[km^{-2} yr^{-1}sr^{-1}]$',fontsize=20)
...
#plt.title('Weighted Flux versus Energy for sarcevic(cos\theta)=1)')

plt.legend(["ERS_min","ERS_std", "ERS_max"],loc ="upper right", fontsize = 20)
plt.show()  
